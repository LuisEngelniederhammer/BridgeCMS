...
require_once SYSTEM_ROOT . '/system/template.controller.class.php';
/*
 *
 */
...
use system\TemplateController;
/*
 * Setup Access System
 * TODO too complicated access system? Security check ?
 */
$client = sessionHelper::init ()->_getClientObject ();
$allowedPageRoles = pageManager::init ()->getBackendPageAccess ( "Templates" ) [0];
...
<body>
	...
	<?php
	menuManager::init ( true )->setActive ( "Templates" )->displayMenu ( true );
	?>
	</div>
	<div id="body_wrapper">
		<div class="content">
			<div class="content-box blue">
				...
				<hr>
				<?php 
				$tplMgr = new TemplateController('debug');
				$tplMgr->getBody();
				?>
			</div>
		</div>
